...
gateways:
  istio-ingressgateway:
    ...
    serviceAnnotations: {
      "alb.ingress.kubernetes.io/healthcheck-port": ${status_port_nodeport},
      "alb.ingress.kubernetes.io/healthcheck-path": ${readinessprobe_httpget_path},
    ...
    podAnnotations: {}
    type: ${loadbalancer_type} #change to NodePort, ClusterIP or LoadBalancer if need be
